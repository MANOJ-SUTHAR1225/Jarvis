...
def playAssistantSound():
    music_dir = "jarvis-main\\www\\assets\\audio\\start_sound.mp3"
        ...
        try:
            ...
            if results:
                ...
                if results:
                    ...
                    speak(app_name+" not found in PC ")
...
def hotword():
    ...
    try:
        ...
        while True:
            ...
            # checking if the keyword is detected
            if keyword_index>=0:
...
def chatBot(query):
    ...
    chatbot = hugchat.ChatBot(cookie_path="jarvis-main/engine/cookies.json")
