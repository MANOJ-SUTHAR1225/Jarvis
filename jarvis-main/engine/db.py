...
cursor = con.cursor()
# cursor.execute("DELETE FROM sys_command WHERE id = 6 or id=7")
...
# query="INSERT INTO sys_command VALUES (null,'power point','C:\\Program Files\\Microsoft Office\\root\\Office16\\POWERPNT.EXE')"
# cursor.execute(query)
# # con.commit()
